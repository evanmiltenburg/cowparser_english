...
If you are looking for a parser for the Dutch data, see [here](https://github.com/evanmiltenburg/cowparser_dutch). For some reason, the Dutch data has a different format from the English one.
